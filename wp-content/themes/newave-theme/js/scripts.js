...
jQuery(document).ready(function(){
    ...
    jQuery(".posaluxToolImg").on("click", function () {        
    ...
    jQuery(".posaluxImg").on("click", function () {        
        jQuery('#imagepreview').attr('src', jQuery(this)[0].children[0].src); // here asign the image to the modal when the user click the enlarge link
        jQuery('#imagemodal').modal('show'); // imagemodal is the id attribute assigned to the bootstrap modal, then i use the show function
    });    
    jQuery(".shape-newForImg").on("click", function () {        
        jQuery('#imagepreview').attr('src', jQuery(this)[0].children[0].src); // here asign the image to the modal when the user click the enlarge link
        jQuery('#imagemodal').modal('show'); // imagemodal is the id attribute assigned to the bootstrap modal, then i use the show function
    });
    jQuery(".pointImg").on("click", function () {        
        jQuery('#imagepreview').attr('src', jQuery(this)[0].children[0].src); // here asign the image to the modal when the user click the enlarge link
        jQuery('#imagemodal').modal('show'); // imagemodal is the id attribute assigned to the bootstrap modal, then i use the show function
    });
    jQuery(".pointToolImg").on("click", function () {        
        jQuery('#imagepreview').attr('src', jQuery(this)[0].children[0].src); // here asign the image to the modal when the user click the enlarge link
        jQuery('#imagemodal').modal('show'); // imagemodal is the id attribute assigned to the bootstrap modal, then i use the show function
    });
    jQuery(".team-person-new").on("click", function () {        
        jQuery('#imagepreview').attr('src', jQuery(this)[0].children[0].src); // here asign the image to the modal when the user click the enlarge link
        jQuery('#imagemodal').modal('show'); // imagemodal is the id attribute assigned to the bootstrap modal, then i use the show function
    });
    jQuery(".team-person-newForImg").on("click", function () {        
        jQuery('#imagepreview').attr('src', jQuery(this)[0].children[0].src); // here asign the image to the modal when the user click the enlarge link
        jQuery('#imagemodal').modal('show'); // imagemodal is the id attribute assigned to the bootstrap modal, then i use the show function
    });
    jQuery(".iceletheImg").on("click", function () {        
        jQuery('#imagepreview').attr('src', jQuery(this)[0].children[0].src); // here asign the image to the modal when the user click the enlarge link
        jQuery('#imagemodal').modal('show'); // imagemodal is the id attribute assigned to the bootstrap modal, then i use the show function
    });
    jQuery(".iceLetheImg").on("click", function () {        
    ...
    if (jQuery('.cnc-row-2').length>0) {
        jQuery('.cnc-row-2').carouFredSel({
            width: '100%',
            height: 'auto',
            prev: '#prev4',
            next: '#next4',
    ...
    if (jQuery('.cnc-row-3').length>0) {
        jQuery('.cnc-row-3').carouFredSel({
            width: '100%',
            height: 'auto',
            prev: '#prev5',
            next: '#next5',
    ...
    if( jQuery('.posalux-row-2').length > 0 ){
		
        jQuery('.posalux-row-2').carouFredSel({
            width: '100%',
            height: 'auto',
            prev: '#prev2',
            next: '#next2',
